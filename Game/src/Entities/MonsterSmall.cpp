#include "MonsterSmall.h"

void MonsterSmall::OnUpdate(Engine::Timestep ts)
{
	...
	glm::vec3 movement = glm::normalize(characterTransformComponent.Translation - monsterTransformComponent.Translation) * 4.0f;
