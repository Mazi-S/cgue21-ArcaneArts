...
namespace Engine::ImGuiUtil {
	...
	bool DrawComboControl(const std::string& label, int& selectionIndex, const std::vector<std::string> values, float columnWidth = 150.0f);
	...
	bool DrawColorControl(const std::string& label, glm::vec3& values, float columnWidth = 150.0f);

	bool InputText(const std::string& label, std::string& text, float columnWidth = 150.0f);

	bool InputPath(const std::string& label, std::string& path, const char* filter, float columnWidth = 150.0f);

	void Text(const std::string& label, const std::string& text, float columnWidth = 150.0f);

	bool Button(const std::string& label, const std::string& buttonLable, ButtonType type = ButtonType::Default, float columnWidth = 150.0f);
	bool Button(const std::string& label, const std::string& buttonLable1, bool& button1, ButtonType type1, const std::string& buttonLable2, bool& button2, ButtonType type2, float columnWidth = 150.0f);

	bool Checkbox(const std::string& label, bool& value, float columnWidth = 150.0f);
	...
	template<typename T, typename UIFunction>
	static void DrawComponent(const std::string& name, Entity entity, UIFunction uiFunction, Entity uiFunctionEntity)
	{
		static const ImGuiTreeNodeFlags treeNodeFlags = ImGuiTreeNodeFlags_Framed
			| ImGuiTreeNodeFlags_FramePadding
			| ImGuiTreeNodeFlags_SpanAvailWidth
